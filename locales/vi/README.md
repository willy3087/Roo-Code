...
<br>
<div align="center">
  <h2>Tham Gia Cộng Đồng eLai Code</h2>
...
<div align="center">
<h1>eLai Code (trước đây là Roo Cline)</h1>
...
**eLai Code** là một **tác nhân lập trình tự trị** được hỗ trợ bởi AI sống trong trình soạn thảo của bạn. Nó có thể:
...
Cho dù bạn đang tìm kiếm một đối tác lập trình linh hoạt, một kiến trúc sư hệ thống, hay các vai trò chuyên biệt như kỹ sư QA hoặc quản lý sản phẩm, eLai Code có thể giúp bạn xây dựng phần mềm hiệu quả hơn.

Kiểm tra [CHANGELOG](../CHANGELOG.md) để biết thông tin chi tiết về các cập nhật và sửa lỗi.

---

## 🎉 Đã Phát Hành eLai Code 3.11

eLai Code 3.11 mang đến những cải tiến hiệu suất đáng kể và các tính năng mới!
...
1. [Cài đặt eLai Code](https://docs.roocode.com/getting-started/installing)
...
eLai Code thích ứng với nhu cầu của bạn với các [chế độ](https://docs.roocode.com/basic-usage/using-modes) chuyên biệt:
...
eLai Code đi kèm với các [công cụ](https://docs.roocode.com/basic-usage/how-tools-work) mạnh mẽ có thể:
...
MCP mở rộng khả năng của eLai Code bằng cách cho phép bạn thêm vô số công cụ tùy chỉnh. Tích hợp với API bên ngoài, kết nối với cơ sở dữ liệu, hoặc tạo các công cụ phát triển chuyên biệt - MCP cung cấp khung để mở rộng chức năng của eLai Code để đáp ứng nhu cầu cụ thể của bạn.

### Tùy Chỉnh

Làm cho eLai Code hoạt động theo cách của bạn với:
...
Cảm ơn tất cả những người đóng góp đã giúp cải thiện eLai Code!
...
**Hãy tận hưởng eLai Code!** Cho dù bạn giữ nó trên dây ngắn hay để nó tự do hoạt động, chúng tôi rất mong được thấy những gì bạn xây dựng. Nếu bạn có câu hỏi hoặc ý tưởng về tính năng, hãy ghé qua [cộng đồng Reddit](https://www.reddit.com/r/RooCode/) hoặc [Discord](https://discord.gg/roocode) của chúng tôi. Chúc lập trình vui vẻ!
