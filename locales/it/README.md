...
<br>
<div align="center">
  <h2>Unisciti alla Community di eLai Code</h2>
...
<div align="center">
<h1>eLai Code (precedentemente Roo Cline)</h1>
...
**eLai Code** è un **agente di codifica autonomo** basato sull'IA che vive nel tuo editor. Può:
...
Che tu stia cercando un partner di codifica flessibile, un architetto di sistema o ruoli specializzati come un ingegnere QA o un product manager, eLai Code può aiutarti a costruire software in modo più efficiente.

Consulta il [CHANGELOG](../CHANGELOG.md) per aggiornamenti dettagliati e correzioni.

---

## 🎉 eLai Code 3.11 Rilasciato

eLai Code 3.11 porta significativi miglioramenti di prestazioni e nuove funzionalità!
...
1. [Installa eLai Code](https://docs.roocode.com/getting-started/installing)
...
eLai Code si adatta alle tue esigenze con [modalità](https://docs.roocode.com/basic-usage/using-modes) specializzate:
...
eLai Code viene fornito con potenti [strumenti](https://docs.roocode.com/basic-usage/how-tools-work) che possono:
...
MCP estende le capacità di eLai Code permettendoti di aggiungere strumenti personalizzati illimitati. Integra con API esterne, connettiti a database o crea strumenti di sviluppo specializzati - MCP fornisce il framework per espandere la funzionalità di eLai Code per soddisfare le tue esigenze specifiche.

### Personalizzazione

Fai funzionare eLai Code a modo tuo con:
...
4. **Debug**:
   Premi `F5` (o **Run** → **Start Debugging**) in VSCode per aprire una nuova sessione con eLai Code caricato.
...
Grazie a tutti i nostri contributori che hanno aiutato a migliorare eLai Code!
...
**Goditi eLai Code!** Che tu lo tenga al guinzaglio corto o lo lasci vagare autonomamente, non vediamo l'ora di vedere cosa costruirai. Se hai domande o idee per funzionalità, passa dalla nostra [community di Reddit](https://www.reddit.com/r/RooCode/) o [Discord](https://discord.gg/roocode). Buona programmazione!
