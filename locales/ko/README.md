...
**eLai Code**는 에디터 내에서 작동하는 AI 기반 **자율 코딩 에이전트**입니다. 다음과 같은 기능을 제공합니다:
...
유연한 코딩 파트너, 시스템 아키텍트, QA 엔지니어나 제품 관리자와 같은 전문화된 역할을 찾고 있든, eLai Code는 더 효율적으로 소프트웨어를 구축하는 데 도움이 될 수 있습니다.
...
eLai Code 3.11이 중요한 성능 개선과 새로운 기능을 제공합니다!
...
1. [eLai Code 설치](https://docs.roocode.com/getting-started/installing)
...
eLai Code는 전문화된 [모드](https://docs.roocode.com/basic-usage/using-modes)로 사용자의 필요에 맞게 적응합니다:
...
eLai Code는 다음과 같은 강력한 [도구](https://docs.roocode.com/basic-usage/how-tools-work)를 제공합니다:
...
MCP는 무제한 커스텀 도구를 추가할 수 있게 하여 eLai Code의 기능을 확장합니다. 외부 API와 통합하고, 데이터베이스에 연결하거나, 특수한 개발 도구를 만들 수 있으며 - MCP는 사용자의 특정 요구를 충족하기 위해 eLai Code의 기능을 확장하는 프레임워크를 제공합니다.

### 사용자 정의

다음과 같은 방법으로 eLai Code를 원하는 방식으로 작동하게 할 수 있습니다:
...
eLai Code를 더 좋게 만드는 데 도움을 준 모든 기여자에게 감사드립니다!
...
**eLai Code를 즐기세요!** 짧은 목줄에 묶어두든 자율적으로 돌아다니게 하든, 여러분이 무엇을 만들지 기대됩니다. 질문이나 기능 아이디어가 있으시면 [Reddit 커뮤니티](https://www.reddit.com/r/RooCode/) 또는 [Discord](https://discord.gg/roocode)를 방문해 주세요. 행복한 코딩 되세요!
