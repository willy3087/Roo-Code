...
<br>
<div align="center">
  <h2>Uniu-vos a la Comunitat eLai Code</h2>
...
<div align="center">
<h1>eLai Code (abans Roo Cline)</h1>
...
**eLai Code** és un **agent de programació autònom** impulsat per IA que viu en el vostre editor. Pot:
...
Tant si busqueu un soci de programació flexible, un arquitecte de sistemes o rols especialitzats com un enginyer de control de qualitat o un gestor de producte, eLai Code us pot ajudar a construir programari de manera més eficient.

Consulteu el [CHANGELOG](../CHANGELOG.md) per a actualitzacions i correccions detallades.

---

## 🎉 eLai Code 3.11 Llançat

eLai Code 3.11 aporta millores significatives de rendiment i noves funcionalitats!
...
1. [Instal·leu eLai Code](https://docs.roocode.com/getting-started/installing)
...
eLai Code s'adapta a les vostres necessitats amb [modes](https://docs.roocode.com/basic-usage/using-modes) especialitzats:
...
eLai Code ve amb potents [eines](https://docs.roocode.com/basic-usage/how-tools-work) que poden:
...
MCP amplia les capacitats de eLai Code permetent-vos afegir eines personalitzades il·limitades. Integreu amb APIs externes, connecteu-vos a bases de dades o creeu eines de desenvolupament especialitzades - MCP proporciona el marc per expandir la funcionalitat de eLai Code per satisfer les vostres necessitats específiques.

### Personalització

Feu que eLai Code funcioni a la vostra manera amb:
...
4. **Depuració**:
   Premeu `F5` (o **Execució** → **Inicia la depuració**) a VSCode per obrir una nova sessió amb eLai Code carregat.
...
Gràcies a tots els nostres col·laboradors que han ajudat a millorar eLai Code!
