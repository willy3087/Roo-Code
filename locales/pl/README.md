...
<br>
<div align="center">
  <h2>Dołącz do społeczności eLai Code</h2>
...
<div align="center">
<h1>eLai Code (wcześniej Roo Cline)</h1>
...
**eLai Code** to napędzany przez AI **autonomiczny agent kodujący**, który funkcjonuje w Twoim edytorze. Potrafi:
...
Niezależnie od tego, czy szukasz elastycznego partnera do kodowania, architekta systemu, czy wyspecjalizowanych ról, takich jak inżynier QA lub menedżer produktu, eLai Code może pomóc Ci budować oprogramowanie efektywniej.

Sprawdź [CHANGELOG](../CHANGELOG.md), aby uzyskać szczegółowe informacje o aktualizacjach i poprawkach.

---

## 🎉 eLai Code 3.11 został wydany

eLai Code 3.11 przynosi znaczące usprawnienia wydajności i nowe funkcje!
...
1. [Zainstaluj eLai Code](https://docs.roocode.com/getting-started/installing)
...
eLai Code dostosowuje się do Twoich potrzeb za pomocą wyspecjalizowanych [trybów](https://docs.roocode.com/basic-usage/using-modes):
...
eLai Code jest wyposażony w potężne [narzędzia](https://docs.roocode.com/basic-usage/how-tools-work), które mogą:
...
MCP rozszerza możliwości eLai Code, umożliwiając dodawanie nieograniczonej liczby niestandardowych narzędzi. Integruj się z zewnętrznymi API, łącz z bazami danych lub twórz wyspecjalizowane narzędzia deweloperskie - MCP zapewnia framework, aby rozszerzyć funkcjonalność eLai Code w celu spełnienia Twoich specyficznych potrzeb.

### Personalizacja

Spraw, aby eLai Code działał po Twojemu za pomocą:
...
Dziękujemy wszystkim naszym współtwórcom, którzy pomogli ulepszyć eLai Code!
