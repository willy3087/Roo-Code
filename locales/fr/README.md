...
<br>
<div align="center">
  <h2>Rejoignez la communauté eLai Code</h2>
...
<div align="center">
<h1>eLai Code (anciennement Roo Cline)</h1>
...
**eLai Code** est un **agent de programmation autonome** propulsé par l'IA, au cœur de votre éditeur. Il peut :
...
Que vous recherchiez un partenaire de codage flexible, un architecte système, ou des rôles spécialisés comme un ingénieur QA ou un chef de produit, eLai Code peut vous aider à développer des logiciels plus efficacement.

Consultez le [CHANGELOG](../CHANGELOG.md) pour des mises à jour détaillées et des corrections.

---

## 🎉 eLai Code 3.11 est sorti

eLai Code 3.11 apporte des améliorations significatives de performance et de nouvelles fonctionnalités !
...
1. [Installer eLai Code](https://docs.roocode.com/getting-started/installing)
...
eLai Code s'adapte à vos besoins avec des [modes](https://docs.roocode.com/basic-usage/using-modes) spécialisés :
...
eLai Code est livré avec des [outils](https://docs.roocode.com/basic-usage/how-tools-work) puissants qui peuvent :
...
MCP étend les capacités de eLai Code en vous permettant d'ajouter un nombre illimité d'outils personnalisés. Intégrez des API externes, connectez-vous à des bases de données ou créez des outils de développement spécialisés - MCP fournit le cadre pour étendre la fonctionnalité de eLai Code afin de répondre à vos besoins spécifiques.

### Personnalisation

Faites fonctionner eLai Code à votre manière avec :
...
Merci à tous nos contributeurs qui ont aidé à améliorer eLai Code !
