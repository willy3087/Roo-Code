...
<br>
<div align="center">
  <h2>eLai Code Topluluğuna Katılın</h2>
...
<div align="center">
<h1>eLai Code (önceki adıyla Roo Cline)</h1>
...
**eLai Code**, editörünüzde çalışan yapay zeka destekli **otonom kodlama aracı**dır. Yapabilecekleri:
...
İster esnek bir kodlama ortağı, ister bir sistem mimarı, isterse QA mühendisi veya ürün yöneticisi gibi uzmanlaşmış roller arıyor olun, eLai Code yazılım geliştirme sürecinizi daha verimli hale getirmenize yardımcı olabilir.

Detaylı güncellemeler ve düzeltmeler için [CHANGELOG](../CHANGELOG.md) dosyasını kontrol edin.

---

## 🎉 eLai Code 3.11 Yayınlandı

eLai Code 3.11 önemli performans iyileştirmeleri ve yeni özellikler getiriyor!
...
1. [eLai Code'u Yükleyin](https://docs.roocode.com/getting-started/installing)
...
eLai Code, özelleştirilmiş [modlar](https://docs.roocode.com/basic-usage/using-modes) ile ihtiyaçlarınıza uyum sağlar:
...
eLai Code, şunları yapabilen güçlü [araçlar](https://docs.roocode.com/basic-usage/how-tools-work) ile gelir:
...
MCP, sınırsız özel araç eklemenize izin vererek eLai Code'un yeteneklerini genişletir. Harici API'lerle entegre olun, veritabanlarına bağlanın veya özel geliştirme araçları oluşturun - MCP, eLai Code'un işlevselliğini özel ihtiyaçlarınızı karşılamak üzere genişletmek için çerçeve sağlar.

### Özelleştirme

eLai Code'u kendi tarzınıza göre çalıştırın:
...
eLai Code'u daha iyi hale getirmeye yardımcı olan tüm katkıda bulunanlara teşekkür ederiz!
