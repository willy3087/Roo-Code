...
<br>
<div align="center">
  <h2>Únete a la comunidad de eLai Code</h2>
...
<div align="center">
<h1>eLai Code (antes Roo Cline)</h1>
...
**eLai Code** es un **agente de programación autónomo** impulsado por IA que vive en tu editor. Puede:
...
Ya sea que busques un socio de programación flexible, un arquitecto de sistemas o roles especializados como ingeniero de control de calidad o gestor de productos, eLai Code puede ayudarte a construir software de manera más eficiente.

Consulta el [CHANGELOG](../CHANGELOG.md) para ver actualizaciones detalladas y correcciones.

---

## 🎉 eLai Code 3.11 Lanzado

¡eLai Code 3.11 trae mejoras significativas de rendimiento y nuevas funcionalidades!
...
1. [Instalar eLai Code](https://docs.roocode.com/getting-started/installing)
...
eLai Code se adapta a tus necesidades con [modos](https://docs.roocode.com/basic-usage/using-modes) especializados:
...
eLai Code viene con potentes [herramientas](https://docs.roocode.com/basic-usage/how-tools-work) que pueden:
...
MCP amplía las capacidades de eLai Code al permitirte añadir herramientas personalizadas ilimitadas. Integra con APIs externas, conéctate a bases de datos o crea herramientas de desarrollo especializadas - MCP proporciona el marco para expandir la funcionalidad de eLai Code para satisfacer tus necesidades específicas.

### Personalización

Haz que eLai Code funcione a tu manera con:
...
¡Gracias a todos nuestros colaboradores que han ayudado a mejorar eLai Code!
