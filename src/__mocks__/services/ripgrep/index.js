 ...
 */
export const getBinPath = jest.fn().mockImplementation(async (_vscodeAppRoot) => {
 ...
 */
export const regexSearchFiles = jest.fn().mockImplementation(async (_cwd, _directoryPath, _regex, _filePattern) => {
 ...
 */
export const truncateLine = jest.fn().mockImplementation((line, _maxLength) => {
	return line || ""
})
