...
describe("read_file tool with maxReadFileLine setting", () => {
	...
	const mockedCountFileLines = countFileLines
	const mockedReadLines = readLines
	const mockedExtractTextFromFile = extractTextFromFile
	const mockedParseSourceCodeDefinitionsForFile = parseSourceCodeDefinitionsForFile
	// Variable to control what content is used by the mock - set in beforeEach
	let mockInputContent = ""
	const mockedIsBinaryFile = isBinaryFile
...
//# sourceMappingURL=read-file-maxReadFileLine.test.js.map
