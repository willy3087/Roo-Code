...
describe("ClineProvider", () => {
	...
	test("addClineToStack adds multiple Cline instances to the stack", () => {
		// prepare test data
		const mockCline1 = { taskId: "test-ta***REMOVED***id-1" } as unknown as Cline
		const mockCline2 = { taskId: "test-ta***REMOVED***id-2" } as unknown as Cline
