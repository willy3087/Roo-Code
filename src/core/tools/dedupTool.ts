...
export const dedupOutputSchema = z.object({
	...
	unique_queries: z
		.array(z.string().describe("Query única, sem duplicidade, < 30 caracteres"))
		.max(3)
 ...
 */
export async function dedupTool(newQueries: string[], existingQueries: string[]): Promise<DedupOutput> {
