...
import { xaiDefaultModelId, xaiModels, REASONING_MODELS } from "../../shared/api"
		...
		for await (const chunk of stream) {
			...
			if (chunk.usage) {
				yield {
					...
					cacheReadTokens: "cache_read_input_tokens" in chunk.usage ? chunk.usage.cache_read_input_tokens : 0,
					cacheWriteTokens:
