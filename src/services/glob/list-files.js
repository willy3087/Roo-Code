 ...
 */
async function parseGitignoreFile(dirPath, recursive) {
	if (!recursive) {
 ...
 */
function shouldIncludeDirectory(dirName, recursive, gitignorePatterns) {
 ...
 */
function isIgnoredByGitignore(dirName, gitignorePatterns) {
