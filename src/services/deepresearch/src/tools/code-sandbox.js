...
function getPrompt(problem, availableVars, previousAttempts = []) {
...
export class CodeSandbox {
	...
	context
	schemaGen
	constructor(context = {}, trackers, schemaGen, maxAttempts = 3) {
	...
	async generateCode(problem, previousAttempts = []) {
...
export function analyzeStructure(value, indent = "") {
	if (value === null) return "null"
	if (value === undefined) return "undefined"
	const type = typeof value
	if (type === "function") {
