...
const configSummary = {
	provider: {
		name: LLM_PROVIDER,
		model:
			LLM_PROVIDER === "openai" ? configJson.models.openai.default.model : configJson.models.gemini.default.model,
