...
export async function* streamTextNaturally(text: string, streamingState: StreamingState) {
...
export function calculateDelay(chunk: string, burstMode: boolean): number {
...
export function getEffectiveLength(chunk: string): number {
...
export async function emitRemainingContent(
	res: Response,
	requestId: string,
	created: number,
	model: string,
...
export async function completeCurrentStreaming(
